...
//        std::cout << std::endl;
        ...
        System.out.println("Checking the extracted message "+msg+" with "+num_msg_bits[0] + " - " + num_msg_bits[1] + " :  " +
        ...
        if ( num_msg_bits[0] + num_msg_bits[1] > 0 ) {
            ...
            System.out.println("Password as not been stored inside the image");
            for ( int i = 0; i < n; i++ )
