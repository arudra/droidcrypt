...
# release
cd executable
#g++ -o2 -stdlib=libstdc++ ../HUGO_like_src/HUGO_like.cpp ../HUGO_like_src/cost_model_config.cpp ../HUGO_like_src/cost_model.cpp ../include/base_cost_model.cpp ../include/base_cost_model_config.cpp ../include/mi_embedder.cpp ../include/stc_ml_c.cpp ../include/stc_embed_c.cpp ../include/stc_extract_c.cpp ../include/common.cpp ../include/image.cpp ../include/info_theory.cpp -o HUGO_like -I../include -L${libsPath} -lboost_program_options-mt -lboost_filesystem-mt -lboost_system-mt
